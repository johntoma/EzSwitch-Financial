!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Vt, Dt),
        h(Vt, yt, Dt.values),
        v(Vt, { slice: kt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: Tt }),
        It(Vt, 'buffer', 'b'),
        It(Vt, 'byteOffset', 'o'),
        It(Vt, 'byteLength', 'l'),
        It(Vt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      nt = function(t) {
        for (var n, r = t === G, e = R(r ? V : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(G, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (f(
        (T = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(V, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), K(this, t, E(1, r));
            };
