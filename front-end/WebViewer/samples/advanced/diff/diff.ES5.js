      ...
      function w(e) {
        return new Promise(function(u) {
          var c,
            l,
            y,
            g = document.getElementById(e.panel);
          WebViewer(
            {
              path: '../../../lib',
              css: './nudge-tool.css',
              workerTransportPromise:
                ...
                (y = l.endsWith('docx') || l.endsWith('pptx') || l.endsWith('xlsx')),
                y && i
                  ? i
                  : !y && r
                  ? r
                  : Core.getDefaultBackendType().then(function(t) {
                      return c && y ? (i = Core.initOfficeWorkerTransports(t, {}, void 0)) : (r = Core.initPDFWorkerTransports(t, {}, void 0));
                    })),
            ...
            var m = g.querySelector('iframe').contentDocument.querySelector('.DocumentContainer');
            i.addEventListener('documentLoaded', function() {
              o.setLayoutMode(l.Single),
                o.setFitMode(y.FitWidth),
                e.panel !== p &&
                  i.getDocument().addEventListener('layersUpdated', function() {
                    var t = d(p);
                    v(p) && (t.refreshAll(), t.updateView());
                  });
            }),
              (m.onscroll = function() {
                var r, e;
              ...
              f.push(e),
              (s[e.panel] = { instance: r, documentContainer: m }),
              u();
          });
        });
      }
