!(function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      tt = function(t) {
        for (var n, r = L(w(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = L(r ? G : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(V, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (f(
          ...
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                (r = n.Core.PDFNet),
                  (o = null),
                  (i = window.parent.window.document),
                  (u = [null, null]),
                  (c = []),
                  (f = (function() {
                    var t = e(
                      regeneratorRuntime.mark(function t(n, e) {
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), r.PDFDoc.create();
                              case 2:
                                return (o = t.sent).lock(), (t.next = 6), o.appendTextDiffDoc(n, e);
                              case 6:
                                return (t.next = 8), o.unlock();
                              case 8:
                                if ((instance.UI.loadDocument(o), c.push([].concat(u)), 1 !== c.length)) {
                                  t.next = 12;
                                  break;
                                }
                                return t.abrupt('return');
                              case 12:
                                (f = i.getElementById('recentFiles')),
                                  ((a = document.createElement('button')).innerText = 'Compare '.concat(n.fileName, ' (A) & ').concat(e.fileName, ' (B)')),
                                  a.classList.add('link'),
                                  (a.onclick = l.bind({ idx: c.length - 1 })),
                                  f.appendChild(a);
                              case 18:
                              case 'end':
                                return t.stop();
                      ...
                      regeneratorRuntime.mark(function t() {
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                if ((n = i.getElementById('compareButton')).classList.contains('disabled')) {
                                  t.next = 3;
                                  break;
                                }
                                return t.abrupt('return');
                                      ...
                                      regeneratorRuntime.mark(function t() {
                                        ...
                                        return regeneratorRuntime.wrap(function(t) {
                                          for (;;)
                                            switch ((t.prev = t.next)) {
                                              case 0:
                                                return (n = u[0]), (r = u[1]), (t.next = 4), f(n, r);
                                              case 4:
                                              case 'end':
                                                return t.stop();
                                            }
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 5:
                                (u[r] = t.sent), (u[r].fileName = n.name), null !== u[1] && null !== u[0] && a();
                              case 8:
                              case 'end':
                                return t.stop();
                            }
                  ...
                  i.getElementById('fileUpload1').addEventListener('change', function(t) {
                    s(t.target.files[0], 0);
                  }),
                  i.getElementById('fileUpload2').addEventListener('change', function(t) {
                    s(t.target.files[0], 1);
                  }),
                  (l = (function() {
                    var t = e(
                      regeneratorRuntime.mark(function t() {
                        return regeneratorRuntime.wrap(
                          function(t) {
                            for (;;)
                              switch ((t.prev = t.next)) {
                                case 0:
                                  return (t.next = 2), f(c[this.idx][0], c[this.idx][1]);
                                case 2:
                                case 'end':
                                  return t.stop();
                              }
                      ...
                      regeneratorRuntime.mark(function t() {
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (o = window.Core).enableFullPDF(), (t.next = 4), r.initialize();
                              case 4:
                                instance.docViewer.addEventListener('documentLoaded', function() {
                                  instance.UI.setLayoutMode(instance.UI.LayoutMode.FacingContinuous), instance.UI.openElements(['notesPanel']);
                                });
                              case 5:
                              case 'end':
                                return t.stop();
                          ...
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), p();
                              case 2:
                                return (t.next = 4), r.PDFDoc.createFromURL('../../samples/files/semantic_test_doc_1.pdf');
                              case 4:
                                return (n = t.sent), (t.next = 7), r.PDFDoc.createFromURL('../../samples/files/semantic_test_doc_2.pdf');
                              case 7:
                                return (e = t.sent), (t.next = 10), f(n, e);
                              case 10:
                                (i.getElementById('fileUpload1').disabled = !1), (i.getElementById('fileUpload2').disabled = !1);
                              case 12:
                              case 'end':
                                return t.stop();
                            }
